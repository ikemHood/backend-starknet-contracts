...
mod tournament_system {
    ...
    impl TournamentSystemImpl of super::ITournamentSystem<ContractState> {
        fn record_match_result(
            ...
            let team1_participation: MatchParticipation = get!(world, (tournament_id, team1_id), MatchParticipation);
            let team2_participation: MatchParticipation = get!(world, (tournament_id, team2_id), MatchParticipation);
            ...
            assert(match_data.team1_id == team1_id && match_data.team2_id == team2_id, INVALID_MATCH);
        ...
        fn add_tournament_organizer(
            ...
            let new_organizer = TournamentOrganizer {
                tournament_id,
                organizer,
                role,
                permissions
